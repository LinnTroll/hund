...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.assistant'
        db.add_column(u'core_show', 'assistant',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.assistant'
        db.delete_column(u'core_show', 'assistant')
    ...
    models = {
        ...
        u'core.show': {
            ...
            'assistant': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
