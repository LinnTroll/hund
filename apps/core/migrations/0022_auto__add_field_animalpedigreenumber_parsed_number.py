...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnimalPedigreeNumber.parsed_number'
        db.add_column(u'core_animalpedigreenumber', 'parsed_number',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnimalPedigreeNumber.parsed_number'
        db.delete_column(u'core_animalpedigreenumber', 'parsed_number')
