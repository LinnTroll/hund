...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocTemplate.created_at'
        db.add_column(u'core_doctemplate', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 8, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocTemplate.created_at'
        db.delete_column(u'core_doctemplate', 'created_at')
