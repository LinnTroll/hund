...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShowMember.number'
        db.alter_column(u'core_showmember', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ShowMember.number'
        db.alter_column(u'core_showmember', 'number', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
