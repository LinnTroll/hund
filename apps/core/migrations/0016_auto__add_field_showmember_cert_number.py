...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowMember.cert_number'
        db.add_column(u'core_showmember', 'cert_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowMember.cert_number'
        db.delete_column(u'core_showmember', 'cert_number')
