...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BreedGroup'
        db.create_table(u'core_breedgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'core', ['BreedGroup'])

        # Adding field 'Breed.group'
        db.add_column(u'core_breed', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BreedGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BreedGroup'
        db.delete_table(u'core_breedgroup')

        # Deleting field 'Breed.group'
        db.delete_column(u'core_breed', 'group_id')
