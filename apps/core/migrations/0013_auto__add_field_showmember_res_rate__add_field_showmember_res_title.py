...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowMember.res_rate'
        db.add_column(u'core_showmember', 'res_rate',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShowMember.res_title'
        db.add_column(u'core_showmember', 'res_title',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowMember.res_rate'
        db.delete_column(u'core_showmember', 'res_rate')

        # Deleting field 'ShowMember.res_title'
        db.delete_column(u'core_showmember', 'res_title')
