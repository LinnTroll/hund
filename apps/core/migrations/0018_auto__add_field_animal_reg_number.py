...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Animal.reg_number'
        db.add_column(u'core_animal', 'reg_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Animal.reg_number'
        db.delete_column(u'core_animal', 'reg_number')
    ...
    models = {
        u'core.animal': {
            ...
            'reg_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'blank': 'True'}),
