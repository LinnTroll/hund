...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocTemplate.settings'
        db.add_column(u'core_doctemplate', 'settings',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocTemplate.settings'
        db.delete_column(u'core_doctemplate', 'settings')
