...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnimalKennel'
        db.create_table(u'core_animalkennel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('animal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Animal'])),
            ('kennel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Kennel'])),
        ))
        db.send_create_signal(u'core', ['AnimalKennel'])

        # Adding model 'Kennel'
        db.create_table(u'core_kennel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('breeder', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Kennel'])


    def backwards(self, orm):
        # Deleting model 'AnimalKennel'
        db.delete_table(u'core_animalkennel')

        # Deleting model 'Kennel'
        db.delete_table(u'core_kennel')
