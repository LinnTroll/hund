...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Owner.email'
        db.alter_column(u'core_owner', 'email', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
        # Deleting field 'Animal.kennel_address'
        db.delete_column(u'core_animal', 'kennel_address')

        # Deleting field 'Animal.kennel_name'
        db.delete_column(u'core_animal', 'kennel_name')

        # Deleting field 'Animal.kennel'
        db.delete_column(u'core_animal', 'kennel')


    def backwards(self, orm):

        # Changing field 'Owner.email'
        db.alter_column(u'core_owner', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        # Adding field 'Animal.kennel_address'
        db.add_column(u'core_animal', 'kennel_address',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animal.kennel_name'
        db.add_column(u'core_animal', 'kennel_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animal.kennel'
        db.add_column(u'core_animal', 'kennel',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'core.animal': {
            ...
            'reg_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'core.animalkennel': {
            'Meta': {'object_name': 'AnimalKennel'},
            'animal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Animal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kennel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Kennel']"})
        },
        u'core.animalowner': {
            'Meta': {'object_name': 'AnimalOwner'},
            'animal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Animal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Owner']"})
        },
        u'core.animalpedigreenumber': {
            ...
            'parsed_number': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100', 'blank': 'True'})
        },
        u'core.animaltitle': {
        ...
        u'core.kennel': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'Kennel'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'breeder': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'core.owner': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'Owner'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'work': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'})
        },
        u'core.show': {
