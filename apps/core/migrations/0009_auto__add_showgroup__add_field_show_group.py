...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowGroup'
        db.create_table(u'core_showgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['ShowGroup'])

        # Adding field 'Show.group'
        db.add_column(u'core_show', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ShowGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ShowGroup'
        db.delete_table(u'core_showgroup')

        # Deleting field 'Show.group'
        db.delete_column(u'core_show', 'group_id')
