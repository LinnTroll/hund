...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShowGroup.catalog'
        db.add_column(u'core_showgroup', 'catalog',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.ShowCatalog'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShowGroup.catalog'
        db.delete_column(u'core_showgroup', 'catalog_id')
